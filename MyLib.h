...
namespace inputuser {
int IntegerNumber(const string &massege){
    cout<<massege<<endl ;
    int number ;
    while (!(cin>>number))
    {
...
unsigned int PositiveIntegerNumber(const string &massege){
    cout<<massege<<endl ;
    int number;
do{
    if(!(cin>>number)){
...
unsigned short PositiveShortNumberInRange (const string &massege ,unsigned short from ,unsigned short to ){
    int number ;
    cout<<massege<<endl ;
    do{
        if (!(cin >> number))  
...
float FloatNumber(const string &massege){
    float number ;
    cout<<massege<<endl ;
    while(!(cin>>number)){
        cin.clear() ;
...
bool YesOrNo (const string &massege){
    string Answer ;
    cout<<massege<<endl;
    do{
        cin>>Answer ;
...
string GetStringInSize (const string &massege,unsigned short from,unsigned short to){
    string text ;
    unsigned size ;
    cout << massege<<endl;
    do{
